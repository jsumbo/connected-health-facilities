...
const SIDEBAR_WIDTH_MOBILE = "min(16rem, 85vw)"
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          className="!w-[min(100%,var(--sidebar-width))] max-w-[var(--sidebar-width)] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
          style={
            {
